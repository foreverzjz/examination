...
class CaptchaDraw
{
    ...
    public function drawCaptcha($word, $isDisplay = FALSE, $useCurve = TRUE, $useNoise = TRUE)
    {
        ...
        for ($i = 0; $i < $len; $i++) {
            ...
            imagettftext($_image, $fontSize, mt_rand(-40, 70), $codeNX, $fontSize * 1.5, $_color, $this->fontFile, $code);
        }
        // 输出图像
        if ($isDisplay) {
